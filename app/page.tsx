...
export default function Home() {
  ...
  const [dataType, setDataType] = useState<'luminaire' | 'outage-area' | 'outage-point'>('luminaire');
  ...
  return (
    <main className="min-h-screen p-8 bg-gray-50">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-3xl font-bold mb-6 text-gray-800">ESRI Data Sync PoC</h1>
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-6">
          ...
          <div className="border-t border-gray-200 pt-4">
            <h2 className="text-lg font-medium text-gray-900 mb-3">Data Preview</h2>
            ...
            {isLoading ? (
              ...
              <div className="text-center py-8 text-gray-500">
                No data available. Click "Refresh Data" to fetch from the API.
              </div>
            )}
          </div>
        </div>
